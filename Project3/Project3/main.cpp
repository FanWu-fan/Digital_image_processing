...
int main()
{
	...
	//imshow("linearFilter-3-color", spt.linearFilter(image_color, filter3, 3));
	...
	//imshow("linearFilter-5-color", spt.linearFilter(image_color, filter5, 5));
	...
	//imshow("linearFilter-9-color", spt.linearFilter(image_color, filter9, 9));

	//使用高斯滤波模板平滑图像
	//3*3 高斯模板

	imshow("GasssionFilter3", spt.GasssionFilter(image, 3, 1.5));
	imshow("GasssionFilter3-color", spt.GasssionFilter(image_color, 3, 1.5));
